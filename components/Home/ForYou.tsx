        ...
        <div>
            ...
            <p className='px-[10rem] text-[1.4rem] '>
                ...
                <span className='font-extralight text-[#343531]'>
                    ...
                    underlying technology uses multiple models to assist in prediction and is developed using zero-knowledge proof to achieve the goal of privacy
                    prediction.
                </span>
            </p>
            ...
            <div className='flex justify-evenly px-[.2rem]'>
                <div className='w-[20rem]'>
                    ...
                    <p className='whitespace-pre-line'>
                        Use zero-knowledge proof to protect user input data. Only the user is aware of the input content and provides Proof for the user to verify.
                    </p>
                </div>
                <div className='w-[20rem]'>
                    <h4 className='iconText flex gap-2 items-end'>
